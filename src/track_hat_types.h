...
enum TH_ErrorCode
{
    ...
    TH_ERROR_DEVICE_DISCONNECTED = -2,
    TH_ERROR_DEVICE_ALREADY_OPEN = -3,
    TH_ERROR_DEVICE_NOT_OPEN = -4,
    TH_ERROR_DEVICE_COMMUNICATION_FAILED = -5,
    TH_ERROR_DEVICE_COMMUNICATION_TIMEOUT = -6,
    TH_ERROR_CAMERA_INTERNAL_BROKEN = -7,
    TH_ERROR_CAMERA_INITIALIZING_FAILED = -8,
    TH_ERROR_CAMERA_SELF_TEST_FAILED = -9,
    TH_ERROR_WRONG_PARAMETER = -10,
    TH_MEMORY_ALLOCATION_FAILED = -11,
